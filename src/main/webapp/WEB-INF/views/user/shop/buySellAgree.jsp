...
<body>
   <div align="center">
      ...
      <c:if test = "${mode eq 'W' }">
      <button type="button" id="confirm" class="btn btn-outline-dark" onclick="location.href = 'buyAuctionInfo.user?prod_num=${dto.prod_num}&mode=${mode }'" disabled width="400">동의후 계속하기</button>
      </c:if>	
   </div>
</body>
</html>
