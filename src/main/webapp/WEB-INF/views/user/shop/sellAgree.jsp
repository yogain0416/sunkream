...
<body>
   <div align="center" class="basicFont">
      <font size="10" color="Red">판매등록</font><font size="10" color="Black">하시기
         전에 꼭 확인하세요.</font> 
      <table>
         <tr align="center">
            <td colspan="2">판매상품 상세 정보</td>
         </tr>
         <tr>
      ...
      <font size="4" color="Black">판매하려는 상품이 맞습니다.</font><br> 
      ...
      <br> <font size="4" color="Black">판매자</font><br> 
      <font size="3" color="Gray">가 보내는 상품의 점수가 검수 기준에 만족하지 않는다면 판매 취소하겠습니다.<br>
   ...
   <form name="f" method="post" action="sellInfo.user">
