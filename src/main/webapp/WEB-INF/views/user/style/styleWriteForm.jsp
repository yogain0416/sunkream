   ...
   <div align="center" class="basicFont">
      <form id="f" action="styleWrite.user" method="post"
         ...
         <table class = "table" style = "width:70%;"> 
            ...
            <tr align = "center">
               <td><textarea class = "form-control" style ="width:60%;height:30%;" id="textarea" rows="10" cols="40"
            ...
            <tr align = "center">
               <td><input type="text" id="search"  class = "form-control" style = "width:40%;height:10%;display:inline;"
                  oninput="searchList('${upPath}','5')" onkeypress="search(event)"
                  placeholder="브랜드,모델명,모델번호 등" size="10">
            ...
            <tr align = "center">
               ...
               <input style=" width: 100px;" type="button" onclick="check()" value="등록" class="btn btn-outline-dark">
               </td>
            </tr>
         </table>
      </form>
