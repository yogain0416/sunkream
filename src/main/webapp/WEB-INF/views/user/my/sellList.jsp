...
<script>
	function changeSearch(check){
		...
		location.href='sellList.user?auction='+check+'&cal1='+cal1+'&cal2='+cal2;
	}
	$(function() {
			...
			<table width="100%">
				<tr>
					...
					<td rowspan="2" width="60%">
						<a href="sellDetail.user?sell_num=${dto.sell_num}&auction=${dto.auction}">
					...
					<td rowspan="2" width="20%">
						<font size="2px" color="gray">
							<input type="text" name="cal" value="${dto.start_date}" 
								style="size:2px; color:gray; border:none;" readOnly>
								~
							<input type="text" name="cal" value="${dto.end_date}" 
								style="size:2px; color:gray; border:none;" readOnly>
						</font>
					</td>
					<td rowspan="2" width="20%">
						...
						<c:if test="${dto.auction == 'X'}">
							<font size="3px" color="red">판매취소</font>
						</c:if>
						<c:if test="${dto.auction == 'Y'}">
							<font size="3px" color="blue">판매완료</font>
						</c:if>
					</td>
				</tr>
			</table>
